      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center animate-fade-in">
          ...
          <p className="text-slate-400 text-lg font-medium">
            Buat akun untuk memulai Rumah digital Anda
          </p>
        </div>
        {/* Main Register Card */}
        <div className="card-modern p-8 animate-slide-up">
          ...
          <div className="mt-8 mb-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-slate-800 text-slate-400">Atau daftar dengan</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            {loading ? 'Sedang Memproses...' : 'Daftar dengan Google'}
          </button>
        </div>
        {/* Login Link */}
