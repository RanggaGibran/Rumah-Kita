...
const AddPet: React.FC<AddPetProps> = ({ homeId, onCancel }) => {
  ...
  // List of pet types and personalities for selection
  const petTypes: PetType[] = ['dog', 'cat', 'bird', 'rabbit', 'fish', 'hamster', 'turtle'];
  ...
  const getPetEmoji = (petType: PetType) => {
    switch (petType) {
      case 'dog': return '🐶';
      case 'cat': return '🐱';
      case 'bird': return '🐦';
